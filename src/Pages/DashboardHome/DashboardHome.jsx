        ...
        <div>
            <section className="flex items-center flex-1 ">
                <div className="flex flex-col w-full ">
                    <h1 className="text-5xl my-6 font-extrabold text-center lg:text-7xl 2xl:text-8xl">
                    ...
                    <p className="max-w-3xl mx-auto mt-6 text-lg text-center text-primary md:text-xl">
                        We are working hard to launch the app soon. Stay tuned for updates!
                    </p>
                    ...
                    <div className="flex flex-col mt-8 space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
                        ...
                        <button className="px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300  bg-blue-500 rounded-md hover:bg-blue-600 focus:bg-blue-600 focus:outline-none sm:mx-2">
                            Notify Me
                        </button>
                    </div>
            ...
            <section className="bg-accent rounded-2xl border border-amber-500 my-6">
                <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
                    <h2 className="text-2xl font-bold tracking-tight  xl:text-3xl text-primary">
                        Career Venture is here to help you grow your career and skills with the best boot camps.
                    </h2>

                    <p className="block max-w-4xl mt-4 text-primary">
                        Get job ready with our platform that connects you with top-rated boot camps offering comprehensive training in various fields. Find the perfect boot camp to boost your career and gain valuable skills.
                    </p>
