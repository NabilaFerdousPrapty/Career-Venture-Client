                      ...
                      <tr key={mentor._id}>
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex items-center gap-x-6">
                            <button className="text-gray-500 transition-colors duration-200 hover:text-red-500 focus:outline-none border border-[#ad8a54] py-1 px-2 rounded-xl ">
                              Delete
                            </button>
                            <button className="text-blue-500 transition-colors duration-200 hover:text-indigo-500 focus:outline-none border border-[#ad8a54] py-1 px-2 rounded-xl ">
                              Edit
                            </button>
                          </div>
                        </td>
