    ...
    <div className="container mx-auto lg:px-4 py-2 px-2">
      <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center bg-accent rounded-3xl my-4">
        ...
        <div className="flex items-center justify-center w-full h-96 lg:w-[55%] ">
          <img
            className="object-cover w-full h-full max-w-3xl rounded-3xl"
      ...
      <div className="w-full flex justify-center items-center my-3 py-5 ">
        <div className="lg:max-w-lg mx-auto text-center text-primary">
          ...
          <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row justify-center items-center border-2 border-amber-700 rounded-3xl px-5 py-2">
            <form className="flex flex-col md:flex-row" onSubmit={handleSubmit(onSubmit)} action="">
              <input
                {...register("search", { required: true })}
                id="text"
                type="text"
                className="px-4 py-2 text-gray-700  border rounded-md dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
      ...
      <h1 className="text-3xl font-semibold  lg:text-4xl text-center mt-4 mb-9 text-primary">
